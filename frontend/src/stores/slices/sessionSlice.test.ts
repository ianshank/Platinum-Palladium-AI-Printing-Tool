...
describe('sessionSlice', () => {
    ...
    describe('Record CRUD', () => {
        ...
        it('addRecord prepends (most recent first)', () => {
            ...
            store.getState().session.addRecord({ ...mockRecord, paperType: 'Second' });
    ...
    describe('Filtering', () => {
        ...
        it('clearFilters resets all filters', () => {
            ...
            expect(store.getState().session.filterDateRange).toEqual({ start: null, end: null });
    ...
    describe('Import/Export', () => {
        ...
        it('exportRecords returns all records', () => {
            store.getState().session.addRecord(mockRecord);
            store.getState().session.addRecord({ ...mockRecord, paperType: 'Bergger COT320' });
