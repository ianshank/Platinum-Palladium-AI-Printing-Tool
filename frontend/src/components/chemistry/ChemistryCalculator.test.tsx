...
describe('ChemistryCalculator', () => {
    ...
    describe('Rendering', () => {
        ...
        it('renders paper size select with current selection', () => {
            render(<ChemistryCalculator />);
            const select = screen.getByTestId('paper-size-select') as HTMLSelectElement;
        ...
        it('highlights active coating method', () => {
            render(<ChemistryCalculator />);
            expect(screen.getByTestId('coating-brush')).toHaveAttribute('aria-checked', 'true');
            expect(screen.getByTestId('coating-rod')).toHaveAttribute('aria-checked', 'false');
        });
    ...
    describe('Accessibility', () => {
        ...
        it('coating method buttons use radio role', () => {
            render(<ChemistryCalculator />);
            expect(screen.getByTestId('coating-brush')).toHaveAttribute('role', 'radio');
        });
    ...
    describe('Customization', () => {
        it('applies custom className', () => {
            ...
            expect(screen.getByTestId('chemistry-calculator')).toHaveClass('custom-class');
        });
    });
});
