...
const Icons = {
  ...
  Flask: () => (
    ...
    >
      ...
      <path d="M10 9V3" />
      <path d="M14 9V3" />
      <path d="M10 9a7.08 7.08 0 0 0-5.9 8.18A2 2 0 0 0 6.07 19h11.86a2 2 0 0 0 1.97-1.82A7.08 7.08 0 0 0 14 9Z" />
    </svg>
  ),
  Sun: () => (
    <svg
  ...
  const statCards = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        subtitle:
          statistics.paper_types.length > 0
      ...
      },
      {
        ...
        subtitle:
          statistics.chemistry_types.length > 0
    ...
    () => [
      {
        ...
        description:
          'Start a new calibration workflow with the step-by-step wizard.',
        icon: <Icons.Plus />,
        path: '/calibration',
        ...
        <div className="flex items-center gap-3">
          {lastFetched && (
            <span
              ...
              data-testid="dashboard-last-fetched"
            >
          ...
          {recentCalibrations.length === 0 ? (
            ...
            <div className="overflow-hidden rounded-lg border">
              <table
                ...
                data-testid="calibrations-table"
              >
