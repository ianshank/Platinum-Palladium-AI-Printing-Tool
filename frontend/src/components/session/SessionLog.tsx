        ...
        <div className="flex gap-2">
          {(['all', 'success', 'partial', 'failure'] as const).map((f) => (
            <button
              ...
              type="button"
              onClick={() =>
                f === 'all' ? clearFilters() : setResultFilter(f)
              }
              className={cn(
                ...
                >
                  ...
                  <td className="px-4 py-3 text-right">
                    <button
                      ...
                      className="rounded-sm px-1 text-xs text-muted-foreground transition-colors hover:text-destructive focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
