...
export function CalibrationWizard() {
  ...
  // Stable ids so each setup label is programmatically associated with its input
  const paperTypeInputId = useId();
  const exposureTimeInputId = useId();
      ...
      case 0: // Setup
        return (
          <div className="space-y-4">
            ...
            <div>
              <label
                htmlFor={exposureTimeInputId}
                className="mb-1 block text-sm font-medium"
              >
                Exposure Time (s)
              </label>
              <Input
                id={exposureTimeInputId}
                type="number"
